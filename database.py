...
_DERS_PROGRAMI_SATIRLARI: list[tuple[str, int, int, str, str]] = [
    ...
    ("ELİF DEDEOĞLU", 1, 1, "7/B", "Rehberlik"),
    ("ELİF DEDEOĞLU", 1, 3, "8/B", "İngilizce"),
    ("ELİF DEDEOĞLU", 1, 5, "7/B", "İngilizce"),
    ("ELİF DEDEOĞLU", 1, 6, "6/B", "İngilizce"),
    ("ELİF DEDEOĞLU", 3, 1, "6/B", "İngilizce"),
    ("ELİF DEDEOĞLU", 3, 2, "6/A", "İngilizce"),
    ("ELİF DEDEOĞLU", 3, 3, "7/A", "İngilizce"),
    ("ELİF DEDEOĞLU", 4, 2, "7/B", "İngilizce"),
    ("ELİF DEDEOĞLU", 4, 3, "5/A", "İngilizce"),
    ("ELİF DEDEOĞLU", 4, 4, "7/A", "İngilizce"),

    ("BEYZANUR AKKIŞ", 0, 1, "7/B", "Matematik"),
    ("BEYZANUR AKKIŞ", 0, 4, "6/B", "Matematik"),
    ("BEYZANUR AKKIŞ", 0, 5, "7/A", "Matematik"),
    ("BEYZANUR AKKIŞ", 0, 6, "6/B", "Matematik Uygulamaları"),
    ("BEYZANUR AKKIŞ", 1, 4, "6/B", "Matematik Uygulamaları"),
    ("BEYZANUR AKKIŞ", 1, 6, "5/B", "Matematik"),
    ...
    ("FUNDA KİRAZ", 2, 2, "5/A", "Sosyal Bilgiler"),
    ("FUNDA KİRAZ", 2, 3, "7/A", "Sosyal Bilgiler"),
    ("FUNDA KİRAZ", 2, 4, "6/A", "Sosyal Bilgiler"),
    ("FUNDA KİRAZ", 2, 6, "7/B", "Sosyal Bilgiler"),
    ...
    ("HAVVA ÖZDEMİR", 0, 7, "5/A", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 1, 3, "6/A", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 1, 4, "6/B", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 1, 5, "5/A", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 1, 6, "8/A", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 2, 1, "7/B", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 2, 2, "5/B", "Din Kültürü ve Ahlak Bilgisi"),
    ("HAVVA ÖZDEMİR", 2, 5, "7/A", "Arapça"),
    ...
    ("HAVVA ÖZDEMİR", 4, 5, "5/B", "Temel Dini Bilgiler"),

    ("İFTARİYE ARSLAN", 1, 2, "8/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 1, 5, "8/B", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 1, 6, "8/A", "Çevre Eğitimi"),
    ("İFTARİYE ARSLAN", 2, 2, "6/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 2, 4, "8/B", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 2, 5, "5/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 2, 6, "8/A", "Çevre Eğitimi"),
    ("İFTARİYE ARSLAN", 3, 1, "8/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 3, 3, "5/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 3, 5, "8/B", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 3, 7, "6/B", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 4, 1, "6/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 4, 3, "8/A", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 4, 4, "6/B", "Fen Bilimleri"),
    ("İFTARİYE ARSLAN", 4, 5, "8/B", "Fen Bilimleri"),
    ...
    ("MERVE TÜRKEL", 4, 5, "5/B", "Türkçe"),
    ("MERVE TÜRKEL", 4, 6, "7/B", "Türkçe"),
    ...
    ("NESLİHAN ÇAKMAK", 1, 3, "6/A", "Matematik Uygulamaları"),
    ("NESLİHAN ÇAKMAK", 1, 4, "5/A", "Rehberlik"),
    ("NESLİHAN ÇAKMAK", 1, 6, "5/A", "Matematik"),
    ...
    ("NESLİHAN ÇAKMAK", 3, 1, "6/A", "Matematik"),
    ("NESLİHAN ÇAKMAK", 3, 3, "8/A", "Matematik"),
    ("NESLİHAN ÇAKMAK", 3, 5, "5/A", "Matematik"),
    ("NESLİHAN ÇAKMAK", 4, 1, "8/B", "Matematik"),
    ("NESLİHAN ÇAKMAK", 4, 2, "6/A", "Matematik Uygulamaları"),
    ("NESLİHAN ÇAKMAK", 4, 3, "5/A", "Matematik"),

    ("ÖZGE KILIÇ", 2, 1, "5/A", "Teknoloji ve Tasarım"),
    ("ÖZGE KILIÇ", 2, 2, "5/A", "Rehberlik"),
    ("ÖZGE KILIÇ", 2, 4, "7/B", "Teknoloji ve Tasarım"),
    ("ÖZGE KILIÇ", 2, 5, "8/B", "Teknoloji ve Tasarım"),
    ("ÖZGE KILIÇ", 2, 6, "7/A", "Teknoloji ve Tasarım"),
    ...
    ("CANTEKİN KURTOĞLU", 4, 1, "6/B", "Türkçe"),
    ("CANTEKİN KURTOĞLU", 4, 2, "6/B", "Türkçe"),
    ("CANTEKİN KURTOĞLU", 4, 3, "6/A", "Rehberlik"),
    ("CANTEKİN KURTOĞLU", 4, 4, "5/A", "Türkçe"),

    ("AYTAÇ ATMACA", 0, 6, "7/A", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 0, 7, "7/B", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 1, 3, "5/B", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 1, 5, "7/B", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 1, 6, "7/A", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 4, 3, "5/B", "Fen Bilimleri"),
    ("AYTAÇ ATMACA", 4, 4, "5/B", "Rehberlik"),
...
def _sinav_hazirlama_init(con: sqlite3.Connection) -> None:
    con.execute("""
        CREATE TABLE IF NOT EXISTS sinav_hazirlama_kayitlari (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            olusturma TEXT NOT NULL,
            guncelleme TEXT NOT NULL,
            ogretmen_id INTEGER NOT NULL REFERENCES ogretmenler(id),
    ...
    """)
    con.execute("""
        CREATE INDEX IF NOT EXISTS idx_sinav_hazirlama_kayitlari_ogretmen
...
def sinav_hazirlama_kaydet(
    ...
    _sinav_hazirlama_init(con)
    now = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    baslik = _sinav_analiz_text(baslik) or "Adsız sınav hazırlığı"
    try:
        sinif_id_val = int(sinif_id) if sinif_id not in (None, "", 0, "0") else None
    except (TypeError, ValueError):
        sinif_id_val = None
    ...
    if kid:
        ...
        cur = con.execute("""
            INSERT INTO sinav_hazirlama_kayitlari (
                olusturma, guncelleme, ogretmen_id, ogretmen_adi, baslik,
                sinif_id, sinif_adi, ders, sinav_adi, egitim_yili, state_json
            )
            VALUES (?,?,?,?,?,?,?,?,?,?,?)
